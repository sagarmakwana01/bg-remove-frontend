...
const RemoveBgInstantly = () => {
  ...
  useEffect(() => {
    const fetchServiceData = async () => {
      try {
        const res = await axios.get(`${apiUrl}/get-background-service-api`); // adjust your backend URL here
        if (res.data.success) {
        ...
        <div className="row">
          <div className="col-lg-5 col-md-6">
            <div className="remove-bg-instantly-items">
              ...
              <h2>{service?.title || 'Remove background instantly with one click'}</h2>
              <p>{service?.description || 'Get images in a white, customized, or transparent background in 3 seconds or less.'}</p>
          ...
          <div className="col-lg-7 col-md-6">
            <div className="remove-bg-instantly-img">
              <img
                src={`${apiUrl}/static/background-remove-service/${service?.ctaImage}`
